...
Процедура ОтправитьФотоВЧатНаСервере(ПутьКФайлу)
	...
	Попытка
		...
		КонецЕсли;
		//мУдалитьФайлы(ИмяФайлаОтправки);
		//мУдалитьФайлы(ИмяФайлаОтправкиКонец);
		//мУдалитьФайлы(ИмяФайла);
		//мУдалитьФайлы(ИмяФайлаОтправкиНачало);
	Исключение
...
Процедура ОтправитьАудиоВЧатНаСервере(ПутьКФайлу)
	...
	//мУдалитьФайлыИмяФайлаОтправки);
	
	//УдалитьФайлы(фывфывфы
	Сообщить(1);
	//мУдалитьФайлы ("ИмяФайлаОтправкиКонец")
	//мУдалитьФа(ИмяФайлаОтправкиНачало )
	
	//сонар не трогай ничего мУдалитьФайлыИмяФайлаОтправки)
КонецПроцедуры
